...
const Navbar = () => {
  ...
  return (
    <div className="flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6">
      <div>
        <h1 className="mt-1 font-epilogue tracking-widest font-bold sm:text-[30px] text-white">
          HopeFelt
          <h5 className="sm:text-[15px]">Redefining Charity !!</h5>
        </h1>
      </div>
      ...
      <div className="sm:flex hidden flex-row justify-end gap-4">
        <CustomButton 
          btnType="button"
          title={address ? 'Create FundRaiser' : 'Connect'}
